                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body bg-light p-4">
                            <table class="table table-hover datatables" id="editable-sample" width="100%">
                                <thead>
                                    <tr class="bg-light">
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('title'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('email'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('address'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('phone'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('country'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('next_renewal_date'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('package'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted"><?php echo lang('status'); ?></th>
                                        <th class="font-weight-bold text-uppercase text-muted no-print"><?php echo lang('options'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
