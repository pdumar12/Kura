        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addSchedule" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group weekday_div d-flex">
                        <label for="exampleInputEmail1"> <?php echo lang('weekday'); ?></label>
                        <select class="form-control col-sm-9 m-bot15" id="weekday" name="weekday" value=''>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group bootstrap-timepicker col-sm-9 timepickers_time">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group bootstrap-timepicker col-sm-9 timepickere_time">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('') ?> <?php echo lang('duration') ?> </label>
