...
class Pservice extends MX_Controller
{
    ...
    public function addNew()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (empty($id)) {     // Adding New Pservice
                ...
                show_swal(lang('service') . ' ' . lang('added'), 'success', lang('added'));
            } else { // Updating Pservice
                $this->pservice_model->updatePservice($id, $data);
                show_swal(lang('service') . ' ' . lang('updated'), 'success', lang('updated'));
            }
            // Loading View
            redirect('pservice');
        }
    ...
    function delete()
    {
        ...
        show_swal(lang('service') . ' ' . lang('deleted'), 'warning', lang('deleted'));
        redirect('pservice');
    }
